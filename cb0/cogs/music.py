...
class Music(commands.Cog):
    ...
    async def start_node(self):
      ...
      self.bot.node = await pomice.NodePool().create_node(bot=self.bot, host="lavalink.lexnet.cc", port=443, password="lexn3tl@val!nk", identifier="usebot", secure=True, spotify_client_id="cbbe1d3cae1642dd8819e8746195c664", spotify_client_secret="6f09eb14821948bd8c5b185228bd1a0d", apple_music=True)
