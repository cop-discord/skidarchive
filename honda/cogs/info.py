...
class info(commands.Cog): 
    ...
    async def ping(self, ctx: commands.Context):
        responses = ["discord.com", "honda's servers", "north korea", "6ix9ines ankle monitor", "no one", "minecraft servers", "your mom", "your lost dad", "your wifi"]
    ...
    async def botinfo(self, ctx):
        ...
        embed.add_field(name="Founder", value=f"`Discord:` `{' '.join(l for l in lis)}`\n`Server:` [here](https://discord.gg/hondabot) & [backup](https://discord.gg/hondabot)", inline=False)
        button = discord.ui.Button(label="invite", style=discord.ButtonStyle.url, url="https://discord.com/api/oauth2/authorize?client_id=1090979901483528242&permissions=8&scope=bot")
        view = discord.ui.View()
        view.add_item(button)
        embed.add_field(name="Stats", value=f"`hondars:` `{sum(g.member_count for g in self.bot.guilds)}`\n`Servers:` `{len(self.bot.guilds)}`", inline=False)
        ...
        embed.add_field(name=" ", value=f"[Powered by HIVELOCITY](https://store.hivelocity.net)", inline=False)
        embed.set_footer(text="honda", icon_url="https://cdn.discordapp.com/attachments/1095072604668305481/1134204121176625232/i1aqqAG.gif")
    ...
    async def help(self, ctx: commands.Context, *, command=None):
        ...
        embed.add_field(name="help", value="honda the dropdown menu below to see commands", inline=False)
        embed.add_field(name="support", value="if u stuck using bot join our [support server](https://discord.gg/hondabot)", inline=False)
