...
class Events(commands.Cog):
    ...
    async def hii_events(self, guild: discord.Guild):
        ...
        button2 = discord.ui.Button(label="support", style=discord.ButtonStyle.url, url="https://discord.gg/dramatic")
