...
#     if check is None: 
#        await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:stop:1034791708216533074> {ctx.author.mention}: You are not whitelisted"), mention_author=True)
#        return False
...
#       await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:stop:1034791708216533074> {ctx.author.mention}: Only the server owner can use this command"), mention_author=True)
#       return False  
...
#     @commands.hybrid_group(aliases=["wl"], invoke_without_command=True)
#     @commands.cooldown(1, 2, commands.BucketType.user)
#     @check_owner()
#     async def whitelist(self, ctx): 
#       embed = discord.Embed(color=0x2B2D31, title="group command: whitelist", description="whitelist your trusted members to prevent them being detected by the antinuke")
...
#               if l == 10:
#                messages.append(mes)
#                number.append(discord.Embed(color=0x2B2D31, title=f"whitelisted ({len(results)})", description=messages[i]))
#                i+=1
#                mes = ""
#                l=0
    
#             messages.append(mes)
#             embed = discord.Embed(color=0x2B2D31, title=f"whitelisted ({len(results)})", description=messages[i])
#             number.append(embed)
#             if len(number) > 1:
...
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: This user is already whitelisted"), mention_author=True)
#         await cursor.execute("INSERT INTO whitelist VALUES (?,?)", (ctx.guild.id, member.id))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Whitelisted {member.mention}"), mention_author=True)
...
#         await cursor.execute("SELECT * FROM whitelist WHERE guild_id = {} AND user_id = {}".format(ctx.guild.id, member.id))
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: This user is not whitelisted"), mention_author=True)
#         await cursor.execute("DELETE FROM whitelist WHERE guild_id = {} AND user_id = {}".format(ctx.guild.id, member.id))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed whitelist from {member.mention}"), mention_author=True)

#     @commands.hybrid_group(aliases=["an"], invoke_without_command=True)
#     @commands.cooldown(1, 2, commands.BucketType.user)
#     @check_whitelist()
#     async def antinuke(self, ctx): 
#       embed = discord.Embed(color=0x2B2D31, title="group command: antinuke", description="protect your server against nukes and raids")
#       embed.set_thumbnail(url=self.bot.user.display_avatar.url)
...
#       vanity = "<:off:1073964894774370375>"
#       ban = "<:off:1073964894774370375>"
#       kick = "<:off:1073964894774370375>"
#       channel = "<:off:1073964894774370375>"
#       roleupdate = "<:off:1073964894774370375>"
#       roledelete = "<:off:1073964894774370375>"
#       async with self.bot.db.cursor() as cursor: 
#          await cursor.execute("SELECT * FROM antinuke WHERE guild_id = {}".format(ctx.guild.id))
#          results = await cursor.fetchall()
#          for result in results: 
#            if result[1] == "vanity": vanity = "<:on:1073964987032273007>"
#            elif result[1] == "ban": ban = "<:on:1073964987032273007>"  
#            elif result[1] == "kick": kick = "<:on:1073964987032273007>"
#            elif result[1] == "channeldelete": channel = "<:on:1073964987032273007>"
#            elif result[1] == "roleupdate": roleupdate = "<:on:1073964987032273007>"
#            elif result[1] == "roledelete": roledelete = "<:on:1073964987032273007>"

#          embed = discord.Embed(color=0x2B2D31, title="antinuke settings")
...
#        if not punishment.lower() in ["ban", "kick", "strip"]: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: **{punishment}** is an invalid punishment. Please choose between ban, kick or strip"), mention_author=True)
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti vanity update module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, ctx.command.name, punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Added anti vanity update module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti vanity update module is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti vanity update module"), mention_author=True)
...
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti ban module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, ctx.command.name, punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Added anti ban module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti ban is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti vaniy module"), mention_author=True)
...
#        if not punishment.lower() in ["ban", "kick", "strip"]: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: **{punishment}** is an invalid punishment. Please choose between kick, kick or strip"), mention_author=True)
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti kick module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, ctx.command.name, punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Added anti kick module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti kick is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti vaniy module"), mention_author=True)
...
#        if not punishment.lower() in ["ban", "kick", "strip"]: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: **{punishment}** is an invalid punishment. Please choose between channel, channel or strip"), mention_author=True)
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}delete'")
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti channel delete module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, ctx.command.name+"delete", punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Added anti channel delete module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}delete'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti channel delete is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = '{ctx.command.name}delete'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti channel delete module"), mention_author=True)
...
#        if not punishment.lower() in ["ban", "kick", "strip"]: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: **{punishment}** is an invalid punishment. Please choose between role, role or strip"), mention_author=True)
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = 'roledelete'")
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti role delete module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, "roledelete", punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Added anti role delete module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = 'roledelete'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti role delete is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = 'roledelete'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti role delete module"), mention_author=True)
...
#         check = await cursor.fetchone()
#         if check is not None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti role update module is already configured"), mention_author=True)
#         await cursor.execute("INSERT INTO antinuke VALUES (?,?,?)", (ctx.guild.id, "roleupdate", punishment))
#         await self.bot.db.commit()
#         await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Added anti role update module"), mention_author=True)
#       elif option.lower() == "unset": 
#        async with self.bot.db.cursor() as cursor: 
#         await cursor.execute(f"SELECT * FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = 'roleupdate'")
#         check = await cursor.fetchone()
#         if check is None: return await ctx.reply(embed=discord.Embed(color=Colors.yellow, description=f"{Emojis.warning} {ctx.author.mention}: Anti role update is not configured"), mention_author=True)  
#         await cursor.execute(f"DELETE FROM antinuke WHERE guild_id = {ctx.guild.id} AND module = 'roleupdate'")
#         await ctx.reply(embed=discord.Embed(color=0x2B2D31, description=f"<:check:1126571720816468129> {ctx.author.mention}: Removed anti role update module"), mention_author=True)
