    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if view.current_player == view.X:
            if interaction.user != player1:
                embed=discord.Embed(color=self.bot.yellow, description=f"{interaction.user.mention} it is not your turn yet")
...
class tictactoe(commands.Cog):
    ...
    @commands.hybrid_command(aliases=["ttt"], help="play tictactoe with a friend", description="fun", usage="<user>")
