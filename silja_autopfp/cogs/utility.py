...
class Utilityy(Cog):
    ...
    async def blacktea(self, ctx: Context): 
     ...
     embed = Embed(color=0x2B2D31, title="BlackTea Matchmaking", description=f"Waiting for players to join. To join react with <:teacupwithouthandle:1143266580151668817>.\nThe game will begin in **20 seconds**")
     ...
     await mes.add_reaction("<:teacupwithouthandle:1143266580151668817>")
     ...
     while len(players) > 1: 
      for player in players: 
       ...
       else: await message.add_reaction("<:teacupwithouthandle:1143266580151668817>")  
