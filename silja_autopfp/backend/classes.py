...
class Emojis:
    """Just emojis"""
    check = "<:check:1126571720816468129>" #<:check:1126571720816468129>
    wrong = " <:cross:1126572030750371985>" #<:cross:1126572030750371985>
    warning = "<:warning:1126572583442206820>" #{Emojis.warning}
